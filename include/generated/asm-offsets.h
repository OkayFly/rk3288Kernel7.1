...
#define TSK_ACTIVE_MM 964 /* offsetof(struct task_struct, active_mm) */
...
#define TI_PREEMPT 68 /* offsetof(struct thread_info, preempt_count) */
#define TI_ADDR_LIMIT 72 /* offsetof(struct thread_info, addr_limit) */
#define TI_TASK 76 /* offsetof(struct thread_info, task) */
#define TI_CPU 80 /* offsetof(struct thread_info, cpu) */
#define TI_CPU_DOMAIN 84 /* offsetof(struct thread_info, cpu_domain) */
#define TI_CPU_SAVE 88 /* offsetof(struct thread_info, cpu_context) */
#define TI_USED_CP 140 /* offsetof(struct thread_info, used_cp) */
#define TI_TP_VALUE 156 /* offsetof(struct thread_info, tp_value) */
#define TI_FPSTATE 168 /* offsetof(struct thread_info, fpstate) */
#define TI_VFPSTATE 312 /* offsetof(struct thread_info, vfpstate) */
