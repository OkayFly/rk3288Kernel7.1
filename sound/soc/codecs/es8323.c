			    ...
			    const struct i2c_device_id *id)
{
	...
	if (es8323->spk_ctl_gpio < 0) {
		...
		printk("@@ can not read property spk ctl gpio\n");
		es8323->spk_ctl_gpio = INVALID_GPIO;
	} else {
	...
	if (es8323->hp_det_gpio < 0) {
		...
		printk("@@ can not read property hp det gpio\n");
	...
	printk("snd soc register codec\n");
	printk("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	printk("~~~~~~~~~~~~~~~~es8323 i2c prob ok  newwww~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
